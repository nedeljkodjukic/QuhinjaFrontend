              ...
              <div class="flex column">
                <div class="flex q-mb-md full-width" style="max-width: 350px">
                  ...
                  <q-input
                    ...
                    v-model="ingridientsForBaseText"
                    filled
                    outlined
                    type="textarea"
                  />
...
export default {
  data() {
    return {
      ...
      dish: null,
      ingridientsForBase:[],
      ingridientsForBaseText: "Sastojci:\n",
      ingridients: [],
    };
  },
  ...
  methods: {
    addToArray() {
        this.ingridientsForBase.push(this.IngridientForAdding.ingridientName);
        this.ingridientsForBase.push(this.IngridientForAdding.ingridientAmount)
        console.log(this.ingridientsForBase);
      this.ingridientsForBaseText +=
        "■ " +
        this.IngridientForAdding.ingridientName +
        ": " +
        this.IngridientForAdding.ingridientAmount +
        "\n";
