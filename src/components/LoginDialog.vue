      ...
      <q-card class="q-py-sm full-width">
        ...
        <q-card-section>
          <q-form class="full-width column q-gutter-y-md q-pa-sm" @submit.prevent="handleLogin">
            ...
            <a class="text-red-1 text-weight-bold" @click="handleForgotPasswordClick" style="text-decoration:none;cursor: pointer">
        ...
        <q-card-section>
          <div class="row q-gutter-x-sm justify-center">
            ...
            <a class="text-red-1 text-weight-bold" @click="handleRegisterClick" style="text-decoration:none;cursor: pointer">
              Registrujte se
            </a>
          </div>
        </q-card-section>
